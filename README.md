...
## Dataset
The dataset for this analysis can be downloaded [here](https://github.com/ZimengLiu923/AB-Testing/blob/main/data.xlsx).

## Context
In this simulated dataset, I conducted an A/B test to evaluate the impact of initiating the background check earlier in the shopper hiring process. The hypothesis was that by completing the necessary prerequisites faster, shoppers would maintain momentum and be more likely to start quickly.
